...
oficial_mil <- 364199978   # Despesa Líquida com Pessoal — DOU (RGF 3º quadr./2025)
nosso_mil   <- round(despesa_liquida / 1000)
diferenca   <- nosso_mil - oficial_mil

rcl_2025_mil <- 1517735497
dtp_sobre_rcl <- nosso_mil / rcl_2025_mil * 100

cat("Nossa Despesa Líquida:  R$", format(nosso_mil,   big.mark=".", decimal.mark=","), "mil\n")
cat("Oficial:  R$",              format(oficial_mil, big.mark=".", decimal.mark=","), "mil\n")
cat("Diferença:  R$",            format(diferenca,   big.mark=".", decimal.mark=","), "mil\n")
cat("DTP / RCL:  ", round(dtp_sobre_rcl, 3), "%\n\n")
...
A Despesa Total com Pessoal consolidada de 2025 foi reproduzida a partir de dados **exclusivamente públicos**, e coincide com o valor oficial. Apesar da complexidade das regras — várias inclusões e exclusões previstas na LRF — cada critério está aqui explícito e nomeado, permitindo que qualquer pessoa confira ou questione uma regra específica. É esse o valor do *literate programming* para a transparência: a metodologia deixa de ser uma "caixa-preta" e passa a ser texto legível ao lado do código que a executa.
